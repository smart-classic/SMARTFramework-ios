...
- (SMBloodPressure *)bloodPressure
{
	if (!_bloodPressure) {
		...
		// create an item for this object
		SMBloodPressure *obj = [SMBloodPressure newWithSubject:rslt.object inModel:self.model];
...
- (SMEncounter *)encounter
{
	if (!_encounter) {
		...
		// create an item for this object
		SMEncounter *obj = [SMEncounter newWithSubject:rslt.object inModel:self.model];
