...
- (NSArray *)administrationStatus
{
	if (!_administrationStatus) {
		
		// get the "administrationStatus" elements
...
- (NSArray *)productName
{
	if (!_productName) {
		...
		self.productName = arr;
	}
	return _productName;
}

- (NSArray *)refusalReason
{
	if (!_refusalReason) {
		
		// get the "refusalReason" elements
