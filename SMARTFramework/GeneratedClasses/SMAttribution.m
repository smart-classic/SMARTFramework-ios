...
- (SMParticipant *)participant
{
	if (!_participant) {
		...
		SMParticipant *obj = [SMParticipant newWithSubject:rslt.object inModel:self.model];
		self.participant = obj ? obj : (id)[NSNull null];
	}
	...
	else if ((id)[NSNull null] == _participant) {
		return nil;
	}
