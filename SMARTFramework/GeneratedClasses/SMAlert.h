...
/**
 *	A class representing "http://smartplatforms.org/terms#Alert" objects, generated from smart.owl.
 */
@interface SMAlert : SMDocument

/// Representing http://smartplatforms.org/terms#alertLevel
@property (nonatomic, strong) SMCodedValue *alertLevel;
