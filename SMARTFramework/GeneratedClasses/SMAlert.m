...
- (SMCodedValue *)alertLevel
{
	if (!_alertLevel) {
		
		// get the "alertLevel" element
		RedlandNode *predicate = [RedlandNode nodeWithURIString:@"http://smartplatforms.org/terms#alertLevel"];
		...
		self.alertLevel = [SMCodedValue newWithModel:newModel];
	}
	return _alertLevel;
}
