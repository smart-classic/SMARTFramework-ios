...
@class SMDocumentWithFormat, SMMedicalRecord;


/**
 *  A class representing "http://smartplatforms.org/terms#ClinicalNote" objects, generated from smart.owl.
 */
@interface SMClinicalNote : SMDocument
