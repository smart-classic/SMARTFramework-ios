...
{
	NSString *path = [NSString stringWithFormat:@"/records/%@/family_histories/", self.record_id];
	[self getObjectsOfClass:[SMFamilyHistory class] from:path callback:callback];
}
