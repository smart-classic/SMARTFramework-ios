/*
 SMImmunizationAdministrationStatus.m
 SMARTFramework
...
@implementation SMImmunizationAdministrationStatus
...
+ (NSString *)rdfType
{
	return @"http://smartplatforms.org/terms/codes/ImmunizationAdministrationStatus";
}
