...
- (SMCodedValue *)severity
{
	if (!_severity) {
		...
		self.severity = [SMCodedValue newWithModel:newModel];
	}
	return _severity;
}
...
- (SMCodedValue *)drugClassAllergen
{
	if (!_drugClassAllergen) {
		...
		self.drugClassAllergen = [SMCodedValue newWithModel:newModel];
	}
...
- (SMCodedValue *)drugAllergen
{
	if (!_drugAllergen) {
		...
		self.drugAllergen = [SMCodedValue newWithModel:newModel];
	}
	return _drugAllergen;
}

- (SMCodedValue *)foodAllergen
{
	if (!_foodAllergen) {
		
		// get the "foodAllergen" element
		RedlandNode *predicate = [RedlandNode nodeWithURIString:@"http://smartplatforms.org/terms#foodAllergen"];
		RedlandStatement *statement = [RedlandStatement statementWithSubject:nil predicate:predicate object:nil];
		RedlandStreamEnumerator *query = [self.model enumeratorOfStatementsLike:statement];
		RedlandStatement *rslt = [query nextObject];
		...
		self.foodAllergen = [SMCodedValue newWithModel:newModel];
	}
...
- (SMCodedValue *)category
{
	if (!_category) {
		...
		self.category = [SMCodedValue newWithModel:newModel];
	}
	return _category;
}
...
- (SMCodedValue *)allergicReaction
{
	if (!_allergicReaction) {
		...
		self.allergicReaction = [SMCodedValue newWithModel:newModel];
	}
