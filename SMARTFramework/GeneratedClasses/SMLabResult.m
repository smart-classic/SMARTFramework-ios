...
- (SMNarrativeResult *)narrativeResult
{
	if (!_narrativeResult) {
		...
		// create an item for this object
		SMNarrativeResult *obj = [SMNarrativeResult newWithSubject:rslt.object inModel:self.model];
...
- (SMQuantitativeResult *)quantitativeResult
{
	if (!_quantitativeResult) {
		...
		// create an item for this object
		SMQuantitativeResult *obj = [SMQuantitativeResult newWithSubject:rslt.object inModel:self.model];
