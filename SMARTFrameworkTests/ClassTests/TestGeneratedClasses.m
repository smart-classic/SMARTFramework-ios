...
- (void)testSMDocument
{
	NSString *rdfPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"SMDocument" ofType:@"rdf"];
	STAssertNotNil(rdfPath, @"Expecting an RDF file for the class SMDocument");
	NSString *rdf = [NSString stringWithContentsOfFile:rdfPath encoding:NSUTF8StringEncoding error:nil];
	SMDocument *item = [SMDocument newWithRDFXML:rdf];
	STAssertNotNil(item, @"Failed to parse RDF");
...
/**
 *  Testing SMFamilyHistoryObservation
 */
- (void)testSMFamilyHistoryObservation
{
	NSString *rdfPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"SMFamilyHistoryObservation" ofType:@"rdf"];
	STAssertNotNil(rdfPath, @"Expecting an RDF file for the class SMFamilyHistoryObservation");
	NSString *rdf = [NSString stringWithContentsOfFile:rdfPath encoding:NSUTF8StringEncoding error:nil];
	SMFamilyHistoryObservation *item = [SMFamilyHistoryObservation newWithRDFXML:rdf];
	STAssertNotNil(item, @"Failed to parse RDF");
...
/**
 *  Testing SMImagingStudy
 */
- (void)testSMImagingStudy
{
	NSString *rdfPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"SMImagingStudy" ofType:@"rdf"];
	STAssertNotNil(rdfPath, @"Expecting an RDF file for the class SMImagingStudy");
	NSString *rdf = [NSString stringWithContentsOfFile:rdfPath encoding:NSUTF8StringEncoding error:nil];
	SMImagingStudy *item = [SMImagingStudy newWithRDFXML:rdf];
	STAssertNotNil(item, @"Failed to parse RDF");
...
/**
 *  Testing SMMedicalImage
 */
- (void)testSMMedicalImage
{
	NSString *rdfPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"SMMedicalImage" ofType:@"rdf"];
	STAssertNotNil(rdfPath, @"Expecting an RDF file for the class SMMedicalImage");
	NSString *rdf = [NSString stringWithContentsOfFile:rdfPath encoding:NSUTF8StringEncoding error:nil];
	SMMedicalImage *item = [SMMedicalImage newWithRDFXML:rdf];
	STAssertNotNil(item, @"Failed to parse RDF");
...
/**
 *  Testing SMPhotograph
 */
- (void)testSMPhotograph
{
	NSString *rdfPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"SMPhotograph" ofType:@"rdf"];
	STAssertNotNil(rdfPath, @"Expecting an RDF file for the class SMPhotograph");
	NSString *rdf = [NSString stringWithContentsOfFile:rdfPath encoding:NSUTF8StringEncoding error:nil];
	SMPhotograph *item = [SMPhotograph newWithRDFXML:rdf];
	STAssertNotNil(item, @"Failed to parse RDF");
