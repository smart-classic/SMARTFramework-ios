 ...
 *
 *  Posts to /records/{record_id}/clinical_notes/, originally named "post_clinical_note". As of SMART 0.6, this is limited to clinical notes, which
 ...
 */
- (void)postClinicalNote:(NSString *)string callback:(SMSuccessRetvalueBlock)callback
{
	NSString *path = [NSString stringWithFormat:@"/records/%@/clinical_notes/", self.record_id];
