...
/**
 *  A class representing "http://smartplatforms.org/terms#SocialHistory" objects, generated from the SMART ontology.
 */
@interface SMSocialHistory : SMBaseDocument
...
/// Representing http://smartplatforms.org/terms#smokingStatus as SMCodedValue
@property (nonatomic, strong) SMCodedValue *smokingStatus;
