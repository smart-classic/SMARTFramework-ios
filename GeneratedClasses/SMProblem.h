...
/**
 *  A class representing "http://smartplatforms.org/terms#Problem" objects, generated from the SMART ontology.
 */
@interface SMProblem : SMBaseDocument
...
/// Representing http://smartplatforms.org/terms#encounters as SMEncounter
...
/// Representing http://smartplatforms.org/terms#problemName as SMCodedValue
@property (nonatomic, strong) SMCodedValue *problemName;

/// Representing http://smartplatforms.org/terms#problemStatus as SMCodedValue
