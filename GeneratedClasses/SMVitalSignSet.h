...
/// Representing http://smartplatforms.org/terms#bloodPressure as SMBloodPressure
@property (nonatomic, strong) SMBloodPressure *bloodPressure;

/// Representing http://smartplatforms.org/terms#bodyMassIndex as SMVitalSign
@property (nonatomic, strong) SMVitalSign *bodyMassIndex;

/// Representing http://purl.org/dc/terms/date as NSString
@property (nonatomic, copy) NSString *date;

/// Representing http://smartplatforms.org/terms#encounter as SMEncounter
@property (nonatomic, strong) SMEncounter *encounter;

/// Representing http://smartplatforms.org/terms#headCircumference as SMVitalSign
@property (nonatomic, strong) SMVitalSign *headCircumference;

/// Representing http://smartplatforms.org/terms#heartRate as SMVitalSign
...
/// Representing http://smartplatforms.org/terms#oxygenSaturation as SMVitalSign
@property (nonatomic, strong) SMVitalSign *oxygenSaturation;

/// Representing http://smartplatforms.org/terms#respiratoryRate as SMVitalSign
@property (nonatomic, strong) SMVitalSign *respiratoryRate;

/// Representing http://smartplatforms.org/terms#temperature as SMVitalSign
@property (nonatomic, strong) SMVitalSign *temperature;

/// Representing http://smartplatforms.org/terms#weight as SMVitalSign
