...
/**
 *  A class representing "http://smartplatforms.org/terms#AllergyExclusion" objects, generated from the SMART ontology.
 */
@interface SMAllergyExclusion : SMBaseDocument

/// Representing http://smartplatforms.org/terms#allergyExclusionName as SMCodedValue
@property (nonatomic, strong) SMCodedValue *allergyExclusionName;
